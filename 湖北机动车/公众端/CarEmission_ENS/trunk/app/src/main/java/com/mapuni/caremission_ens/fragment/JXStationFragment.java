...
import com.mapuni.caremission_ens.utils.DensityUtils;
...
public class JXStationFragment extends BaseFragment implements ExpandableListView.OnChildClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mControl.requestForAllJXStation(call);
        initView(mView);
        return mView;
    }

    public static JXStationFragment newInstance(String s) {
        JXStationFragment fragment = new JXStationFragment();
