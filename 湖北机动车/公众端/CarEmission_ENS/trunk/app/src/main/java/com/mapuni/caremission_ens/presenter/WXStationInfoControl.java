...
public class WXStationInfoControl extends BaseControl{
    private String id;
    private String title;
    private NetControl netControl;
    private String[] keys = new String[]{"REGION","STATIONNAME","STATIONADDRESS","FZRPHONE","STATIONSTATE","QIYOUCOUNT",
            "QINGCHAICOUNT","ZHONGCHAICOUNT","BUILDSTATECOUNT","CHAIQIHUNHECOUNT","BUSINESS","NOTBUSINESS"};
    private String[] names = new String[]{"行政区名称:","检测站名称:","检测站地址:","负责人电话:","检测站状态:",
            "汽油检测线数量:","轻柴检测线数量:","重柴检测线数量:","在建检测线数量:","柴汽混合数量：","营业:","不营业:"};

    private String[] key=new String[]{"XCKH","QYMC","JYFW","SSQY","QYDZ","LXR","QIYLB"};
    private String[] name=new String[]{"企业编号","企业名称","经营范围","所属区域","企业地址","联系人","企业类别"};
    ...
    public void requestData(StringCallback call){
        ...
        netControl.requestForWXStationSearch(id,call);
    }
    ...
    public List transDataJX(JSONObject object) {
        ...
        for (int i = 0; i < key.length; i++) {
            DetailBean bean = new DetailBean();
            try {
                String value  = object.getString(key[i]).trim();
