		...
		public void handleMessage(Message msg) {
			try {
				...
				case 1:
					...
					//获取PendingIntent
					Intent mainIntent = new Intent(NoticeService2.this, AlarmReportListActivity.class);
//					mainIntent.putExtra("noticeListTran", new NoticeListTranstanceBean(noticelist));
					PendingIntent mainPendingIntent = PendingIntent.getActivity(NoticeService2.this, 0, mainIntent, PendingIntent.FLAG_UPDATE_CURRENT);
					//创建 Notification.Builder 对象
					NotificationCompat.Builder builder = new NotificationCompat.Builder(NoticeService2.this)
							.setSmallIcon(R.mipmap.yutu)
							//点击通知后自动清�?
							.setAutoCancel(true)
							.setContentTitle("�����д�����Ⱦ���μ����ƽ̨")
							.setContentText("����"+noticelist.size()+"��������Ϣ��δ�鿴")
