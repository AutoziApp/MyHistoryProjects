...
public class ZtycActivity extends BaseMapActivityTDT implements ViewCallback,
	...
	void initView() {
		...
		mPopView = LayoutInflater.from(mContext).inflate(R.layout.popview_ztyc,
				null);
		...
		data.add(new DbNews("济南二机床", "槐荫区", "良", "", "详情"));
		data.add(new DbNews("山东华森混凝土", "历下区", "轻度污染", "", "详情"));
		data.add(new DbNews("山东金銮混凝土", "市中区", "中度污染", "", "详情"));
