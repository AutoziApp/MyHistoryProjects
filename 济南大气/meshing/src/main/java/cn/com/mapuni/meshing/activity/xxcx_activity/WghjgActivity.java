...
public class WghjgActivity extends BaseMapActivityTDT implements ViewCallback,
	...
	void initView() {
		...
		biaoti1.setText("任务名称");
		biaoti2.setText("污染类型");
		...
		data.add(new DbNews("山东天鹅棉机", "噪声污染", "已办", "", "详情"));
		data.add(new DbNews("济南二机床集团有限公司", "大气污染", "催办", "", "详情"));
		data.add(new DbNews("济南皇冠油墨有限公司", "水体污染", "催办", "", "详情"));
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				mapView.updateViewLayout(mPopView, new MapView.LayoutParams(
						...
						point, -13, -50, MapView.LayoutParams.BOTTOM_CENTER));
	...
	void initMapView() {
		...
		upload.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
//				Intent intent = new Intent(mContext, DbscfkActivity.class);
//				intent.putExtra("taskName", "企业治理");
//				intent.putExtra("cjsj", "2017-02-24");
//				intent.putExtra("clsj", "2017-02-24");
//				intent.putExtra("id", "87DEBD99-3550-4DEE-87DC-01B9FF5A75BA");
