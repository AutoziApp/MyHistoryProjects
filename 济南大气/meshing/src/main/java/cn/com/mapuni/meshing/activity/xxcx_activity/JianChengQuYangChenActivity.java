...
public class JianChengQuYangChenActivity extends BaseMapActivityTDT implements
	...
	private void initView() {
		...
		list.add(myLocation);
		drawablelist.add(R.drawable.yangchen);
		...
		marker = this.getResources().getDrawable(R.drawable.yangchen);
		...
		data.add(new DbNews("三箭瑞福苑", "市中区", "良", "", "详情"));
		data.add(new DbNews("明湖花园", "天桥区", "轻度污染", "", "详情"));
		data.add(new DbNews("燕柳园", "历下区", "良", "", "详情"));
