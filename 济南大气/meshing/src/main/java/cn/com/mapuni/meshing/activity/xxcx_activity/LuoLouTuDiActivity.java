...
public class LuoLouTuDiActivity extends BaseMapActivityTDT implements
	...
	private void initView() {
		...
		Drawable marker = this.getResources().getDrawable(R.drawable.lltd_icon);
		...
		marker = this.getResources().getDrawable(R.drawable.tree);

		mPopView = LayoutInflater.from(this).inflate(R.layout.popview_lltd, null);

		biaoti1.setText("绿化城区");
		biaoti2.setText("可绿化面积");
		biaoti3.setText("完成率");
		biaoti4.setText("");
		...
		data.add(new DbNews("槐荫区", "45万平方米", "30%", "", "详情"));
		data.add(new DbNews("历下区", "102万平方米", "75%", "", "详情"));
		data.add(new DbNews("市中区", "65万平方米", "56%", "", "详情"));
