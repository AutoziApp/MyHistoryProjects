...
public class ZgdycActivity extends BaseMapActivityTDT implements ViewCallback,
	...
	void initView() {
		...
		mPopView = LayoutInflater.from(mContext).inflate(R.layout.popview_zgdyc,
				null);
		biaoti1.setText("监测站点");
		biaoti2.setText("地址");
		...
		data.add(new DbNews("经十路", "市中区", "良", "", "详情"));
		data.add(new DbNews("顺河高架路", "天桥区", "轻度污染", "", "详情"));
		data.add(new DbNews("二环东高架路", "历下区", "良", "", "详情"));
