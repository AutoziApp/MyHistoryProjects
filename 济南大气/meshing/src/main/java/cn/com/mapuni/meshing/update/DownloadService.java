package cn.com.mapuni.meshing.update;
...
import cn.com.mapuni.meshing.update.UpdateApkActivity;
...
//		preferences = getSharedPreferences("config", MODE_PRIVATE);
	...
	public class DownloadBinder extends Binder {
		...
		public void addCallback(UpdateApkActivity.ICallbackResult callback) {
	...
	private void setUpNotification() {
		...
		contentView.setTextViewText(R.id.name, "济南市大气污染防治监管总平台.apk 正在下载...");
		// 指定个性化视图
