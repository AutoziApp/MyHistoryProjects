...
import cn.com.mapuni.gis.meshingtotal.model.ZTCGPSBean;
...
public class ZhaTuCheGPSActivity extends BaseMapActivityTDT implements
    ...
    List<ZTCGPSBean> data;
    private ZTCGPSBean bean;
    ...
    class OverItemT extends ItemizedOverlay<OverlayItem> implements
        ...
        public OverItemT(Drawable marker, List<ZTCGPSBean> zbdata) {
        ...
        protected boolean onTap(int i) {
            ...
            if (data != null && data.size() > 0) {
                ...
                tppe1.setText(data.get(i).getCPHM());
                tppe2.setText(data.get(i).getSHGS());
            }
...
//            }
    ...
    private void readRiskSources() {
        ...
        //接口调用方法一
        String url = PathManager.JINAN_URL + PathManager.getAllOneHourZTCloctionArrayInfo;
        ...
        utils.send(HttpRequest.HttpMethod.POST, url,params, new RequestCallBack<String>() {
            ...
            public void onFailure(HttpException arg0, String arg1) {
                Toast.makeText(ZhaTuCheGPSActivity.this, "数据请求失败", Toast.LENGTH_SHORT).show();
                if (yutuLoading != null) {
...
//				updateList();
                ...
                try {
                    ...
                    if (jsonArray != null && jsonArray.length() > 0) {
                        for (int i = 0; i < jsonArray.length(); i++) {
                            String CPHM = jsonArray.getJSONObject(i).optString("CPHM");
                            ...
                            String SHGS = jsonArray.getJSONObject(i).optString("SHGS");
                            bean = new ZTCGPSBean(CPHM,Latitude, Longitude, SHGS);
                            data.add(bean);
                        }
                    }
                } catch (Exception e) {
    ...
    public class DbNewsAdapyer extends BaseAdapter {
        ...
        private List<ZTCGPSBean> list;

        public DbNewsAdapyer(Context context, List<ZTCGPSBean> list) {
        ...
        public View getView(int i, View view, ViewGroup arg2) {
            ...
            ZTCGPSBean ztcgpsBean=list.get(i);
            viewHolder.grdrecodename.setText(i+1+"");
            viewHolder.gridpeople.setText(ztcgpsBean.getCPHM());
