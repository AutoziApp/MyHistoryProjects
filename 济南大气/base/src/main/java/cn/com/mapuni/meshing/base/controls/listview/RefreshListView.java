...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private void init(Context context) {
		...
		headView = (LinearLayout) inflater.inflate(R.layout.base_refresh_listhead, null);
	...
	private void changeHeaderViewByState() {
		...
		case RELEASE_To_REFRESH:
			...
			lastUpdatedTextView.setText("上次更新:" + df.format(new Date()));
			arrowImageView.clearAnimation();
			arrowImageView.startAnimation(animation);

			tipsTextview.setText("松开更新");

			LogUtil.v(TAG, "当前状态，松开更新");
			break;
		...
		case DONE:
			...
			progressBar.setVisibility(View.GONE);
			arrowImageView.clearAnimation();
			arrowImageView.setImageResource(R.drawable.base_arrow);
			tipsTextview.setText("下拉更新");
			lastUpdatedTextView.setVisibility(View.VISIBLE);
