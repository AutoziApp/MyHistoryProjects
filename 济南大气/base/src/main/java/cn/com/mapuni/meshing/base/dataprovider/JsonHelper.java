 ...
 * Create at: 2012-12-3 下午02:01:18
 */
public class JsonHelper {
	 ...
	 * @param node   json的键名数组
	 * @return
	 */
	public static ArrayList<HashMap<String, Object>> paseJSON(String result,
			String[] node) {
	 ...
	 * @return
	 */
	public static HashMap<String, ArrayList<HashMap<String, Object>>> paseJSON(
			String result, String[] node, ArrayList<String[]> nodeArrayList) {
