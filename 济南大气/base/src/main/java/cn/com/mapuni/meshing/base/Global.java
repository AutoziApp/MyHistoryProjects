...
import cn.com.mapuni.meshing.base.business.BaseUsers;
...
//wsc public class Global extends Application {
	...
	/**
	 * Description: 获取当前在map地图上是否现场执法了
	 * true ： 在执法记录中更新
	 */
	...
	/**
	 * Description: 设置当前在map地图上是否现场执法了
	 * true ： 在执法记录中更新
	 */
