...
/**
 * FileName: ReturnHome.java Description:返回主页面的广播接收器 
 * <li>接收广播，返回主页面 
 * <li>接收广播，退出系统时停止服务 
 * <li>退出系统时切换APN 
 * <li>接收短信，实现一些安全机制
 ...
 * Create at: 2012-12-3 上午10:49:56
 */
public class SpeakBroadcastReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (ACTION_LOGIN_SPEAK.equals(intent.getAction())) {
			if(!userID.equals("")) {
				int taskSize = new cn.com.mapuni.meshing.base.business.BaseUsers(context).getTaskByUserIDandStatus(userID , "002").size();
				System.out.println(taskSize+"    语音播报进来了吗？");
				//语音播报
				String info = "欢迎登陆环保通系统，您的待执行任务有" + taskSize + "条";
