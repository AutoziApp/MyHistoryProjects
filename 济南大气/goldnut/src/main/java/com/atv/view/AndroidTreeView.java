...
import com.atv.holder.SimpleViewHolder;
...
public class AndroidTreeView {
    ...
    private TreeNode.TreeNodeClickListener callbackListener;
    ...
    private TreeNode.BaseNodeViewHolder getViewHolderForNode(TreeNode node) {
        ...
        if (viewHolder == null) {
            try {
                final Object object = defaultViewHolderClass
                		.getConstructor(Context.class,TreeNode.TreeNodeClickListener.class)
                		.newInstance(mContext,this.callbackListener);
