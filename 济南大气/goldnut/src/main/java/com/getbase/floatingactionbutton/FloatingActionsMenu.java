...
public class FloatingActionsMenu extends ViewGroup implements View.OnClickListener{
  ...
  private OnFAMItemClickListener onFAMItemClickListener;
   ...
   *
   */
  public interface OnFAMItemClickListener {
  ...
  public void addButton(String title,int icon) {
	  FloatingActionButton button = new FloatingActionButton(mContext);
	  button.setTitle(title);
	  button.setIcon(icon);
	  button.setId(mButtonsCount - 1);
  ...
  public void setOnItemClickListener(OnFAMItemClickListener listener){
	  this.onFAMItemClickListener = listener;
  }
  ...
  public void onClick(View v) {
	...
	if(this.onFAMItemClickListener !=null){
		this.onFAMItemClickListener.click(v,v.getId());
	}
  }
}
