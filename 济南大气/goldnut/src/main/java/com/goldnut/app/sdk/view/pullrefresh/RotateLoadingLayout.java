...
import com.goldnut.app.sdk.tool.ViewTool;
...
public class RotateLoadingLayout extends LoadingLayout {
	...
	protected View createLoadingView(Context context, AttributeSet attrs) {
		...
		FrameLayout.LayoutParams params = (FrameLayout.LayoutParams) iv_header_progressbar
				.getLayoutParams();
		params.width = ViewTool.dip2px(context, 45);
		params.height = ViewTool.dip2px(context, 45);
