...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
	...
	*/
	...
	protected boolean isPullLoading() {
		return (mPullUpState == State.LOADING);
	}
	...
	protected boolean isRefreshing(){
		...
		return (mPullDownState == State.REFRESHING || mPullUpState == State.LOADING);
	}
	...
	protected void startLoading() {
		...
		mPullUpState = State.LOADING;
		onStateChanged(State.LOADING, false);

		if (null != mFooterLayout) {
			mFooterLayout.setState(State.LOADING);
		}
