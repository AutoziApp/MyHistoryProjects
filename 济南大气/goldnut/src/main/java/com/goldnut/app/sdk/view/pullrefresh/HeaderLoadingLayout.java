...
public class HeaderLoadingLayout extends LoadingLayout {
	...
	/** 进度条 */
	private ImageView iv_header_progressbar;
	/** 状态提示TextView */
	...
	private void init(Context context) {
		...
		iv_header_progressbar = (ImageView) findViewById(R.id.iv_header_progressbar);
	...
	public void setLoadingDrawable(Drawable drawable){
		if(iv_header_progressbar!=null){
			iv_header_progressbar.setImageDrawable(drawable);
		}
	}
	...
	protected void onStateChanged(State curState, State oldState) {
		...
		iv_header_progressbar.setVisibility(View.VISIBLE);
