 ...
 */
public class ObjectDialogAdapter<T> extends DialogAdapter<T> {

    public ObjectDialogAdapter(Context context) {
        super(context, R.layout.dl_simple_text_item);
    }

    public ObjectDialogAdapter(Context context, List<T> data) {
