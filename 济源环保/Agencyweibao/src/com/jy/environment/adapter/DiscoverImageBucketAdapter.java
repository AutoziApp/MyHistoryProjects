...
import com.jy.environment.util.BitmapCache;
import com.jy.environment.util.BitmapCache.ImageCallback;



public class DiscoverImageBucketAdapter extends BaseAdapter {
	...
	public DiscoverImageBucketAdapter(Activity act, List<ImageBucket> list) {
		this.act = act;
		dataList = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			holder = new Holder();
			arg1 = View.inflate(act, R.layout.discover_image_bucket_item, null);
