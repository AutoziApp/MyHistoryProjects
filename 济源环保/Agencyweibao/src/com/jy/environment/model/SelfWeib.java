...
public class SelfWeib {
	...
	public SelfWeib(List<Pinglun> pinglun, String id, String username,
			String nc, String icon, String time, String content, String status,
			List<String> small_pics, List<String> big_pics, String dianz,
			List<String> dianz_users, String zhuanfa, String showlevel,
			String env_state, String userId, List<String> dianz_usersId,
			String address, String lon, String lat, List<String> dianz_usersNc,
			int postsCount, int imagesCount, int commentCount,String isakey) {
		super();
		this.pinglun = pinglun;
		this.id = id;
		this.username = username;
	...
	public String toString() {
		return "SelfWeib [imagesCount=" + imagesCount + ", postsCount="
				+ postsCount + ", commentCount=" + commentCount + ", pinglun="
				+ pinglun + ", id=" + id + ", username=" + username
				+ ", userId=" + userId + ", nc=" + nc + ", icon=" + icon
				+ ", time=" + time + ", status=" + status + ", address="
				...
				+ dianz_usersNc + ", isZanGuo=" + isZanGuo + ", isHestory="
				+ isHestory + "]";
	}
