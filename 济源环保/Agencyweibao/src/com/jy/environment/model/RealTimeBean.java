...
public class RealTimeBean {
    ...
    public static class DetailBean {
        ...
        private CitymeanBean countymean;
        private List<CitymeanBean> municipalities;
        private List<CitymeanBean> straightcounty;
		...
		public CitymeanBean getCountymean() {
			return countymean;
		}

		public void setCountymean(CitymeanBean countymean) {
			this.countymean = countymean;
		}

		public List<CitymeanBean> getMunicipalities() {
			return municipalities;
		}

		public void setMunicipalities(List<CitymeanBean> municipalities) {
			this.municipalities = municipalities;
		}

		public List<CitymeanBean> getStraightcounty() {
			return straightcounty;
		}

		public void setStraightcounty(List<CitymeanBean> straightcounty) {
