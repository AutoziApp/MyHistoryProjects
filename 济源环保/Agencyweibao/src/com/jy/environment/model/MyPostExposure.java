...
public class MyPostExposure implements Serializable{
    /**
     * 
     */
	...
	public static boolean deleteInfo(Context context, MyPostExposure info) {
	FileOutputStream fileOutputStream = null;
	ObjectOutputStream objectOutputStream = null;
	List<MyPostExposure> infos = null;
	try {
	    // 存入数据
    ...
    public static boolean saveInfo(Context context, MyPostExposure info) {
	FileOutputStream fileOutputStream = null;
	ObjectOutputStream objectOutputStream = null;
	List<MyPostExposure> infos = null;
	try {
		...
		infos = new ArrayList<MyPostExposure>();
		infos.add(info);
	    }
	    for (int i = 0; i < infos.size(); i++) {
    ...
    public static ArrayList<MyPostExposure> getWeiboInfoHestory(Context context) {
	FileInputStream fileInputStream = null;
	ObjectInputStream objectInputStream = null;
	ArrayList<MyPostExposure> myPostExposures = null;
	try {
	    File file = new File(Environment.getExternalStorageDirectory()
		    .toString()
		    + File.separator
	    ...
	    MyLog.i("Weibo getWeiboInfoHestory !file.exists():"
		    + !file.exists());
	    if (!file.exists()) {
		return myPostExposures;
	    }
	    // 取出数据
	    fileInputStream = new FileInputStream(file.toString());
	    objectInputStream = new ObjectInputStream(fileInputStream);
	    myPostExposures = (ArrayList<MyPostExposure>) objectInputStream.readObject();
	    for (int i = 0; i < myPostExposures.size(); i++) {
		MyLog.i("Weibo getWeiboInfoHestory myPostWeiboInfos " + i + ":"
			+ myPostExposures.get(i).toString());
	    }
	    return myPostExposures;
	} catch (Exception e) {
    ...
    public MyPostExposure(int isShare, String lat, String lng,
	    String user_name, String content, int env, int star,
	    String province, String info_city, String address, int isopen,
	    List<String> paths, long sendTime,String userId,String userPic,String pollutionType,int isanonymous) {
	super();
	this.isShare = isShare;
	this.lat = lat;
	this.lng = lng;
	...
	public String toString() {
		return "MyPostExposure [isShare=" + isShare + ", lat=" + lat + ", lng="
				+ lng + ", user_name=" + user_name + ", content=" + content
				+ ", env=" + env + ", star=" + star + ", province=" + province
				+ ", info_city=" + info_city + ", address=" + address
				+ ", isopen=" + isopen + ", paths=" + paths + ", sendTime="
				+ sendTime + ", userId=" + userId + ", userPic=" + userPic
