...
public class StationViewPagerActivity extends Activity implements
	...
	private void initView() {
		...
		for (int i = 0; i < count; i++) {
			View view = LayoutInflater.from(StationViewPagerActivity.this)
		...
		stationviewpager.setCurrentItem(position);
		if (position == 0) {
			title_station_name.setText(aqiStationModels.get(0).getPosition()
					+ "1/" + count);
	...
	public void onPageSelected(int arg0) {
		// TODO Auto-generated method stub
		position = arg0;
		title_station_name.setText(aqiStationModels.get(arg0).getPosition()
				+ (arg0 + 1) + "/" + count);
		getWeatherTask = new GetWeatherTask();
		getWeatherTask.execute("");
	}
	...
	private void fillData(MonitorModel result) {
		// TODO Auto-generated method stub
		View view = stationviewLists.get(position);
	...
	private void initView(View view, MonitorModel result) {
		...
		TextView tv_aqi_trend, tv_pm25_trend, tv_pm10_trend;
		...
		detail_polluction.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(StationViewPagerActivity.this,
				...
				intent.putExtra("stationname", aqiStationModels.get(position)
						.getPosition());
...
//		monitor_pathView_24h_pm25.setDate(pm25_24_Lists);
		...
		monitor_polluction.setText(getDuValue(result.getAQI()));
