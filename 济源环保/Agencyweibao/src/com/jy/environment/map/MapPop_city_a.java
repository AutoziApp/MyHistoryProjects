...
public class MapPop_city_a extends LinearLayout {
	...
	public MapPop_city_a(Context context, AttributeSet attrs) {
		super(context, attrs);

	}

	public MapPop_city_a(Context context, String snippet,
			EnvTypeOnMapEnum aqitype) {
		super(context);
		_city = snippet;
		_type = aqitype;
		...
		String ccode = citydb.getCityCode(_city);
		String url = UrlComponent.aqihistoryURL + ccode + "/one"
				+ UrlComponent.token;
		MyLog.i(">>>>>>>>>>>historyurl" + url);
		aqihistoryTask task = new aqihistoryTask();
		task.execute(url, _city, "");

	}

	public MapPop_city_a(Context context, String snippet, String aqi,
			EnvTypeOnMapEnum aqitype) {
		super(context);
		_city = snippet;
		_type = aqitype;
