...
public class PathView_ShiDu extends View {
	...
	public PathView_ShiDu(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public PathView_ShiDu(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public PathView_ShiDu(Context context) {
		super(context);
		init(context);
	}
