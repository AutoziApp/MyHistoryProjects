...
public class PathView_24h_pm25 extends View {
	...
	public PathView_24h_pm25(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public PathView_24h_pm25(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public PathView_24h_pm25(Context context) {
		super(context);
		init(context);
	}
