...
public class PathViewOld_24 extends View {
	...
	public PathViewOld_24(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public PathViewOld_24(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}

	public PathViewOld_24(Context context) {
		super(context);
		init(context);
	}
	...
	private void doDraw(Canvas canvas) {
		...
		for (int i = 0; i < data.length; i++) {
			...
			if (i != data.length - 1) {
				...
				LinearGradient linearGradient = new LinearGradient(x + 4, yPotion, xPoint.get(i + 1), nextYPotion, colors, null,  TileMode.REPEAT);
