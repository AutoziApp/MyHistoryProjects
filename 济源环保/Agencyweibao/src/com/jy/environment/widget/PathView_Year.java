...
public class PathView_Year extends View {
	...
	public static final int DAY_YEAR = 5;
	...
	public PathView_Year(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public PathView_Year(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void calculateLeft() {
		...
		case DAY_YEAR:
			...
			// defaultDay =hours;
			for (int i = 0; i < 12; i++) {
				defaultDay[i] = EnvironmentWeatherRankkActivity.years[i];
			}
			break;
