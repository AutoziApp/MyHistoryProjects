...
//	private String apkUrl = "http://www.shenbianer.com.cn:8080/epservice/api/app/update";
	private String apkUrl = UrlComponent.downApkUrl_Get;
	// private String apkUrl = MyApp.downloadApkUrl;
	/* 下载包安装路径 */
	private static final String savePath = "/sdcard/weibao_agency_update/";

	private static final String saveFileName = savePath + "weibao_agency_AppUpdate.apk";
...
//				editor.commit();
			...
			case 1:
				...
				if (rate < 100) {
					...
					Intent intent = new Intent(mContext, UpdateNotificationActivity.class);
					// 告知已完成
...
//		preferences = getSharedPreferences("config", MODE_PRIVATE);
		mUpdate = UpdateManagerUtil.getUpdateManager().getmUpdate();
...
//		binder.start();//YYF
	...
	private void setUpNotification() {
		...
		contentView.setTextViewText(R.id.name, "河南省空气质量.apk 正在下载...");
		// 指定个性化视图
