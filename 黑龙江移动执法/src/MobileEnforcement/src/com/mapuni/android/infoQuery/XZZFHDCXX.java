 ...
 * @version 1.1.0
 */
public class XZZFHDCXX extends BaseClass implements Serializable, IDetailed, IList{

	/**实体类的名字*/
	public static final String BusinessClassName = "XZZFHDCXX";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "WRY_XZZFHDCXX";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "WRY_XZZFHDCXX";
	
	/**该实体类所在表的主键*/
	private static final String primaryKey = "id";
	/**查询该实体类的相关信息所用的表名*/
	private static final String tableName = "T_WRY_XZZFHDCXX";
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "行政执法后监督详情";
	/**该实体类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "行政执法后监督列表";
...
//		String order="wjsj desc limit "+x+","+j;
	...
	public ArrayList<HashMap<String, Object>> getDataList() {
		String sql = "SELECT   * FROM T_WRY_XZZFHDCXX";
...
//		return DBHelper.getList(tableName, fliterHashMap);
