...
/**
 * FileName: HBSTSYSXX.java Description: 环评三同时
 * 
 * @author 王红娟
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司 Create at: 2012-12-3 上午09:38:56
 */
public class WRWPFFQ extends BaseClass implements Serializable, IDetailed, IList {

	/** 实体类的名字 */
	public static final String BusinessClassName = "FQWRWPF";
	/** 获取该实体类列表样式的标题 */
	private static final String ListStyleName = "WRY_FQWRWPF";
	/** 获取该实体类数据详情样式的标题 */
	private static final String DetailedStyleName = "WRY_FQWRWPF";
	...
	/** 查询该实体类的相关信息所用的表名 */
	private static final String tableName = "T_WRY_FQPFKPFWRWXX";
	/** 该实体类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "废气排放污染物详情";
	/** 该实体类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "废气排放污染物信息";
	 ...
	 * @author 王红娟 Create at: 2012-12-3 上午09:41:54
	 */
	...
	public ArrayList<HashMap<String, Object>> getDataList() {
		...
		String sql = "SELECT   * FROM T_WRY_HBSXLXQK";
