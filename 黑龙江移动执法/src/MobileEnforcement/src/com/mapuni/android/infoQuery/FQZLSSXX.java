 ...
 */
public class FQZLSSXX extends BaseClass implements Serializable, IDetailed, IQuery, IList {

	/** 实体类的名字 */
	public static final String BusinessClassName = "FQZLSSXX";
	/** 获取该实体类列表样式的标题 */
	private static final String ListStyleName = "WRY_FQZLSS";
	/** 获取该实体类数据详情样式的标题 */
	private static final String DetailedStyleName = "WRY_FQZLSS";
	/** 获取该实体类查询样式的标题 */
	private static final String QueryStyleName = "FQZLSS";
	/** 该实体类所在表的主键 */
	private static final String primaryKey = "Id";
	/** 获取该实体类底部菜单的标题 */
	private static final String BottomMenuName = "XQ";
	/** 查询该实体类的相关信息所用的表名 */
	private static final String tableName = "T_WRY_FQZLSS";
	/** 该实体类在显示详情是所用的名字标题 */
	private final String DetailedTitleText = "治理设施信息详情";
	/** 该实体类在显示列表的时候所用的名字标题 */
	private final String ListTitleText = "废气治理设施运行情况";
	/** 该实体类在执行查询操作的时候所用的名字标题 */
	private final String QueryTitleText = "废气治理设施信息查询";
	/** 初始化当前该实体类列表滚动的次数 */
	...
	public ArrayList<HashMap<String, Object>> getDataList(HashMap<String, Object> fliterHashMap) {
		...
		return DBHelper.getList(tableName, hashMap);
	}
	...
	public HashMap<String, Object> getDetailed(String id) {
		...
		// primaryKeyMap);
		Object mySql = "SELECT a.* , b.* FROM T_WRY_FQZLSS as a LEFT JOIN " + "(select qymc,qydm from T_WRY_QYJBXX where qydm = (select wrybh from T_WRY_FQZLSS where id = " + id
				+ " )) as b " + "ON a . WRYBH = b . QYDM where b.qydm =(select wrybh from T_WRY_FQZLSS where id = " + id + " ) and a.id = " + id;
