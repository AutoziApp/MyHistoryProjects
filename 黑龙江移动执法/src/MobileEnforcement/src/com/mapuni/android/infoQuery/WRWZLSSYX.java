 ...
 */
public class WRWZLSSYX extends BaseClass implements Serializable, IDetailed, IList {
	
	/**实体类的名字*/
	public static final String BusinessClassName = "WRWZLSSYX";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "WRY_WRWZLSSYX";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "WRY_WRWZLSSYX";
	...
	/**查询该实体类的相关信息所用的表名*/
	private static final String tableName = "T_WRY_FSZLSSXX";
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "污染物治理情况详情";
	/**该实体类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "污染物治理情况列表";
...
//		return BaseClass.DBHelper.getList(tableName);
		String sql = "SELECT   * FROM T_WRY_FSZLSSXX";
	...
	public ArrayList<HashMap<String, Object>> getDataList(
		...
		//String newSql = "SELECT   * FROM T_WRY_HBSXLXQK ";
	
		//LogUtil.d("newSql sql is ===>", newSql);
	//	su.getList("", fliterHashMap, tableName);
		return su.getList(tableName, fliterHashMap);
	}
