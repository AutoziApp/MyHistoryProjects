 ...
 */
public class SCSSYXQK extends BaseClass implements Serializable, IDetailed, IList {
	
	/**实体类的名字*/
	public static final String BusinessClassName = "SCSSYXQK";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "WRY_SCSSYXQK";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "WRY_SCSSYXQK";
	...
	/**查询该实体类的相关信息所用的表名*/
	private static final String tableName = "T_WRY_SCSSYXQK";
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "生产设施运行情况详情";
	/**该实体类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "生产设施运行情况列表";
...
//		return BaseClass.DBHelper.getList(tableName);
		String sql = "SELECT   * FROM T_WRY_SCSSYXQK";
