 ...
 * 
 */
public class QYPMT extends BaseClass implements Serializable, IDetailed, IList{
	/**实体类的名字*/
	public static final String BusinessClassName = "QYPMT";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "T_WRY_QYPMT";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "T_WRY_QYPMT";
	
	/**该实体类所在表的主键*/
	private static final String primaryKey = "id";
	/**查询该实体类的相关信息所用的表名*/
	private static final String tableName = "T_Attachment";
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "企业平面图";
	/**该实体类在显示列表的时候所用的名字标题*/
	...
	public ArrayList<HashMap<String, Object>> getDataList() {
		String sql = "select FileName from T_Attachment where FK_Id = '230102000363' and FK_Unit = '69'";
	...
	public ArrayList<HashMap<String, Object>> getDataList(HashMap<String, Object> fliterHashMap) {
		String sql = "select FileName,FilePath from T_Attachment where FK_Id = '" + fliterHashMap.get("QYDM") + "' and FK_Unit = '69'";
		return SqliteUtil.getInstance().queryBySqlReturnArrayListHashMap(sql);
}
