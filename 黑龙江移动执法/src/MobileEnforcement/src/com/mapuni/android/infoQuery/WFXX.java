 ...
 * Description: 危废信息
 */
public class WFXX extends BaseClass implements Serializable, IDetailed,IList {
	
	/**实体类的名字*/
	public static final String BusinessClassName = "WFXX";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "WRY_WFXX";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "WRY_WFXX";
	...
	/**查询该实体类的相关信息所用的表名*/
	private static final String tableName = "T_WRY_WFXX";
	/**该实体类在显示详情是所用的名字标题*/
...
//		return BaseClass.DBHelper.getList(tableName);
		String sql = "SELECT   * FROM T_WRY_WFXX";
	...
	public HashMap<String, Object> getStyleList(Context content)
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "WFXX");
			e.printStackTrace();
		}
		return styleList;
	}
