 ...
 */
public class HYPWSF extends BaseClass implements Serializable, IDetailed, IList {
	
	/**实体类的名字*/
	public static final String BusinessClassName = "HYPWSF";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "WRY_HYPWSF";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "WRY_HYPWSF";
	...
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "行业排污收费情况详情";
	/**该实体类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "行业排污收费情况列表";
