 ...
 */
public class FQPWKQK extends BaseClass implements Serializable, IDetailed,IList {
	
	/**实体类的名字*/
	public static final String BusinessClassName = "FQPWKQK";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "WRY_FQPWKQK";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "WRY_FQPWKQK";
	...
	/**查询该实体类的相关信息所用的表名*/
	private static final String tableName = "T_WRY_FQPFKXX";
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "废气排污口情况详情";
	/**该实体类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "废气排污口情况";
...
//		return BaseClass.DBHelper.getList(tableName);
		String sql = "SELECT   * FROM T_WRY_FQPFKXX";
	...
	public HashMap<String, Object> getStyleList(Context content)
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "FQPFKXX");
			e.printStackTrace();
		}
		return styleList;
	}
