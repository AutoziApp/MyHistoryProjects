 ...
 * Description: 固废、灰渣
 */
public class GFHZ extends BaseClass implements Serializable, IDetailed,IList {
	
	/**实体类的名字*/
	public static final String BusinessClassName = "GFHZ";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "WRY_GFHZ";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "WRY_GFHZ";
	...
	/**查询该实体类的相关信息所用的表名*/
	private static final String tableName = "T_WRY_GFHZ";
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "固废灰渣储存场所详情";
	/**该实体类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "固废灰渣储存场所情况";
...
//		return BaseClass.DBHelper.getList(tableName);
		String sql = "SELECT   * FROM T_WRY_GFHZ";
	...
	public HashMap<String, Object> getStyleList(Context content)
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "FSPFKXX");
			e.printStackTrace();
		}
		return styleList;
	}
	...
	public ArrayList<HashMap<String, Object>> getStyleDetailed(Context context) {
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "GFHZ");
