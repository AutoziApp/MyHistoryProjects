 ...
 */
public class WRWPF extends BaseClass implements Serializable, IDetailed,IList {
	
	/**实体类的名字*/
	public static final String BusinessClassName = "WRWPF";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "WRY_WRWPF";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "WRY_WRWPF";
	...
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "污染物排放情况详情";
	/**该实体类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "污染物排放情况列表";
