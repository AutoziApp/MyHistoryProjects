...
/**
 * FileName: XZCFXX.java Description: 行政处罚信息
 * 
 * @author 王红娟
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司 Create at: 2012-12-4 下午03:06:33
 */
public class XZCFXX extends BaseClass implements Serializable, IDetailed,
		IQuery, IList {

	/** 实体类的名字 */
	public static final String BusinessClassName = "XZCFXX";
	/** 获取该实体类列表样式的标题 */
	private  final String ListStyleName = "WRY_XZCF";
	/** 获取该实体类数据详情样式的标题 */
	private  final String DetailedStyleName = "WRY_XZCF";
	/** 获取该实体类查询样式的标题 */
	private  final String QueryStyleName = "XZCF";
	/** 该实体类所在表的主键 */
	private  final String primaryKey = "guid";
	/** 获取该实体类底部菜单的标题 */
	private  final String BottomMenuName = "XQ";
	/** 查询该实体类的相关信息所用的表名 */
	private  final String tableName = "V_WRY_XZCF";
	/** 该实体类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "行政处罚信息详情";
	/** 该实体类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "行政处罚信息列表";
	...
	public XZCFXX() {
		try {
			styleList = XmlHelper
					.getListStyleByName(ListStyleName,
	 ...
	 * @author 王红娟 Create at: 2012-12-4 下午03:07:21
	 */
	...
	public HashMap<String, Object> getStyleList(Context content)
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "XZCFXX");
			e.printStackTrace();
		}
		return styleList;
	}
	 ...
	 * @author 王红娟 Create at: 2012-12-4 下午03:06:19
	 */
