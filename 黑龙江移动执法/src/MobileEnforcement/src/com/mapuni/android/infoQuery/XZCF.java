...
public class XZCF extends BaseClass implements Serializable, IDetailed, IList {

	/** 实体类的名字 */
	public static final String BusinessClassName = "XZCF";
	/** 获取该实体类列表样式的标题 */
	private static final String ListStyleName = "WRY_JYXZCF";
	/** 获取该实体类数据详情样式的标题 */
	private static final String DetailedStyleName = "WRY_JYXZCF";

	/** 该实体类所在表的主键 */
	private static final String primaryKey = "id";
	/** 查询该实体类的相关信息所用的表名 */
	private static final String tableName = "T_WRY_JYXZCF";
	/** 该实体类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "行政处罚";
	/** 该实体类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "行政处罚";
