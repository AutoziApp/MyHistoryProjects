 ...
 * 危废信息
 */
public class WRWPFWF extends BaseClass implements Serializable, IDetailed,IList {
	
	/**实体类的名字*/
	public static final String BusinessClassName = "WRWPFWF";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "WRY_WRWPFWF";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "WRY_WRWPFWF";
	...
	/**查询该实体类的相关信息所用的表名*/
	private static final String tableName = "T_WRY_WasteInformation";
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "危废信息详情";
	/**该实体类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "危废信息";
...
//		return BaseClass.DBHelper.getList(tableName);
		String sql = "SELECT   * FROM T_WRY_WasteInformation";
	...
	public ArrayList<HashMap<String, Object>> getDataList(
		...
		condition.put("WRYBH", fliterHashMap.get("QYDM"));
		
		
		return su.getList(tableName, condition);
	}
	...
	public HashMap<String, Object> getStyleList(Context content)
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "WRWPFWF");
			e.printStackTrace();
		}
		return styleList;
	}
