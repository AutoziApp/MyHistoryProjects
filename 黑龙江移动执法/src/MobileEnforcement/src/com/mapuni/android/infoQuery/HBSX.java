 ...
 */
public class HBSX extends BaseClass implements Serializable, IDetailed,IList {
	
	/**实体类的名字*/
	public static final String BusinessClassName = "HBSX";
	/**获取该实体类列表样式的标题*/
	private static final String ListStyleName = "WRY_HBSX";
	/**获取该实体类数据详情样式的标题*/
	private static final String DetailedStyleName = "WRY_HBSXLXQK";
	...
	/**查询该实体类的相关信息所用的表名*/
	private static final String tableName = "T_WRY_HBSXLXQK";
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "环保手续履行情况详情";
	/**该实体类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "环保手续履行情况列表";
