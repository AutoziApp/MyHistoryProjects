 ...
 */
public class LSJCQK extends BaseClass implements Serializable, IDetailed, IList {

	/** 业务类的名字 */
	public static final String BusinessClassName = "LSJCQK";
	/** 获取该业务类列表样式的标题 */
	private  final String ListStyleName = "JCJL_LSJCQK";
	/** 获取该业务类数据详情样式的标题 */
	...
	/** 查询该业务类的相关信息所用的表名 */
	private  final String tableName = " T_WRY_LSZFQK";
	/** 该业务类在显示详情是所用的名字标题 */
