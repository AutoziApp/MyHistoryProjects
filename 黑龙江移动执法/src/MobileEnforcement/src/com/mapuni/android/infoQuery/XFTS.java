...
public class XFTS extends BaseClass implements Serializable, IDetailed, IList {

	/** 实体类的名字 */
	public static final String BusinessClassName = "XFTS";
	/** 获取该实体类列表样式的标题 */
	private static final String ListStyleName = "WRY_XFTS";
	/** 获取该实体类数据详情样式的标题 */
	private static final String DetailedStyleName = "WRY_XFTS";

	/** 该实体类所在表的主键 */
	private static final String primaryKey = "id";
	/** 查询该实体类的相关信息所用的表名 */
	private static final String tableName = "T_WRY_XFTS";
	/** 该实体类在显示详情是所用的名字标题 */
	...
	public ArrayList<HashMap<String, Object>> getDataList(
		...
		String sql = "select * from T_WRY_XFTS where QYDM = '" + qydm + "'";
