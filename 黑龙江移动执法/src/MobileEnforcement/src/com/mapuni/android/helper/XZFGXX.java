...
/**
 * FileName: XZFGXX.java
 * Description: 行政法规信息
 * @author 包坤
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司
 * Create at: 2012-12-4 下午03:12:13
 */
public class XZFGXX extends BaseClass implements IDetailed, IList, IQuery,
		Serializable {
	
	/** 实体类的名字 */
	public static final String BusinessClassName = "XZFGXX";
	/** 获取该实体类列表样式的标题 */
	 ...
	 * String
	 * @author 王红娟
	 * Create at: 2012-12-4 下午03:13:40
	 */
...
//		String order = "ymbt asc limit " + x + "," + j;
	...
	public ArrayList<HashMap<String, Object>> getStyleQuery(Context context) {
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "XZFGXX");
	...
	public List<HashMap<String, Object>> getSpinner(String AdapterFileName,
		...
		List<HashMap<String, Object>> spinnerdata  = BaseClass.DBHelper.getList(AdapterFileName,
					querycondition);
