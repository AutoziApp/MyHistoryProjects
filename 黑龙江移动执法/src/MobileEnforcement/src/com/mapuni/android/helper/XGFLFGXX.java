...
/**
 * FileName: XGFLFGXX.java
 * Description: 相关法律法规信息
 * @author 王红娟
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司
 * Create at: 2012-12-4 下午02:57:05
 */
public class XGFLFGXX extends BaseClass implements IDetailed, IList, IQuery,
		Serializable {
	
	/** 实体类的名字 */
	public static final String BusinessClassName = "XGFLFGXX";
	/** 获取该实体类列表样式的标题 */
	...
	/** 该实体类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "法律法规信息详情";
	/** 该实体类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "相关法律法规";
	/** 该实体类在执行查询操作的时候所用的名字标题 */
	private String QueryTitleText = "相关法律法规信息查询";
	/** 初始化当前该实体类列表滚动的次数 */
...
//		String order = "scsj desc limit " + x + "," + j;
	...
	public ArrayList<HashMap<String, Object>> getStyleQuery(Context context) {
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "XGFLFGXX");
