...
/**
 * FileName: HJZLBZXX.java
 * Description: 环境质量标准信息实体类*
 * @author 包坤
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司
 * Create at: 2012-12-3 上午09:42:39
 */
public class HJZLBZXX extends BaseClass implements IDetailed, IList, IQuery,
		Serializable {
	
	/**实体类的名字*/
	public static final String BusinessClassName = "HJZLBZXX";
	/**获取该实体类列表样式的标题*/
	...
	/**该实体类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "环境质量标准信息详情";
	/**该实体类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "环境质量标准";
	/**该实体类在执行查询操作的时候所用的名字标题*/
	private String QueryTitleText = "环境质量标准信息查询";
	/**初始化当前该实体类列表滚动的次数*/
     ...
     * String
     * @author 包坤
     * Create at: 2012-12-3 上午09:45:15
     */
...
//		String order = "ymbt asc limit " + x + "," + j;
	...
	public ArrayList<HashMap<String, Object>> getStyleQuery(Context context) {
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "HJZLBZXX");
