...
/**
 * FileName: DFFGXX.java 
 * Description:地方法规信息业务类
 * @author 包坤
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司 
 * Create at: 2012-11-30 下午04:04:45
 */
public class DFFGXX extends BaseClass implements IDetailed, IList, IQuery,
		Serializable {
	/** 业务类的名字 */
	public static final String BusinessClassName = "DFFGXX";
	/** 获取该业务类列表样式的标题 */
	...
	/** 该业务类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "地方法规信息详情";
	/** 该业务类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "地方法规信息列表";
	/** 该业务类在执行查询操作的时候所用的名字标题 */
	private String QueryTitleText = "地方法规信息查询";
	/** 初始化当前该业务类列表滚动的次数 */
	 ...
	 * @author 包坤
	 * Create at: 2012-11-30 下午04:08:27
	 */
