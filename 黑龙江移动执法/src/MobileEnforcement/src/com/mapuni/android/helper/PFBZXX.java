...
/**
 * FileName: PFBZXX.java 
 * Description: 排放标准
 * @author 包坤
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司 
 * Create at: 2012-12-4 上午10:06:11
 */
public class PFBZXX extends BaseClass implements IDetailed, IList, IQuery,
		Serializable {
	
	/** 业务类的名字 */
	public static final String BusinessClassName = "PFBZXX";
	/** 获取该业务类列表样式的标题 */
	...
	/** 该业务类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "排放标准信息详情";
	/** 该业务类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "排放标准";
	/** 该业务类在执行查询操作的时候所用的名字标题 */
	private String QueryTitleText = "排放标准信息查询";
	/** 初始化当前该业务类列表滚动的次数 */
	 ...
	 * String
	 * @author 包坤
	 * Create at: 2012-12-4 上午10:07:55
	 */
...
//		String order = "ymbt asc limit " + x + "," + j;
	...
	public ArrayList<HashMap<String, Object>> getStyleQuery(Context context) {
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "PFBZXX");
