...
/**
 * FileName: JCZNXX.java 
 * Description: 监察指南业务类
 * @author 王留庚
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司 
 * Create at: 2012-12-3 上午11:06:07
 */
public class JCZNXX extends BaseClass implements IDetailed, IList, IQuery,
		Serializable {

	/** 业务类的名字 */
	public static final String BusinessClassName = "JCZNXX";
	/** 获取该业务类列表样式的标题 */
	...
	/** 该业务类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "监察指南信息详情";
	/** 该业务类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "监察指南";
	/** 该业务类在执行查询操作的时候所用的名字标题 */
	private String QueryTitleText = "监察指南信息查询";
	/** 初始化当前该业务类列表滚动的次数 */
	 ...
	 * String
	 * @author 王留庚 
	 * Create at: 2012-12-3 上午11:09:02
	 */
...
//		String order = "ymbt asc limit " + x + "," + j;
	...
	public ArrayList<HashMap<String, Object>> getStyleQuery(Context context) {
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "JCZNXX");
