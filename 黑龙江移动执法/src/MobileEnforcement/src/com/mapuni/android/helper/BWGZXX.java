 ...
 * Description: 部委规章的业务类
 * @author 包坤
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司 
 * Create at: 2012-11-30 下午02:25:48
 */
public class BWGZXX extends BaseClass implements IDetailed, IList, IQuery,
	...
	/** 该业务类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "部委规章信息详情";
	/** 该业务类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "部委规章";
	/** 该业务类在执行查询操作的时候所用的名字标题 */
	private String QueryTitleText = "部委规章信息查询";
	/** 初始化当前该业务类列表滚动的次数 */
	 ...
	 * @author 包坤 
	 * Create at: 2012-11-30 下午02:32:43
	 */
