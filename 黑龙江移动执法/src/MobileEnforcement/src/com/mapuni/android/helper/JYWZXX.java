 ...
 * Create at: 2012-12-3 上午11:10:35
 */
public class JYWZXX extends BaseClass implements IDetailed, IList, IQuery,
	...
	/** 该业务类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "救援物资信息详情";
	/** 该业务类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "救援物资信息列表";
	/** 该业务类在执行查询操作的时候所用的名字标题 */
	private String QueryTitleText = "救援物资信息查询";
	/** 初始化当前该业务类列表滚动的次数 */
	 ...
	 * String
	 * @author 王红娟 
	 * Create at: 2012-12-3 上午11:13:20
	 */
