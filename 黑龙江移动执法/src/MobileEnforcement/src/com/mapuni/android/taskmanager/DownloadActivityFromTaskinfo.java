...
import com.mapuni.android.base.TextProgressBar;
import com.mapuni.android.base.business.DataSyncModel;
import com.mapuni.android.base.interfaces.IList;
import com.mapuni.android.base.util.LogUtil;
import com.mapuni.android.netprovider.Net;

public class DownloadActivityFromTaskinfo extends Activity {
...
//				showSyncLog();
				Intent aintent = new Intent(DownloadActivityFromTaskinfo.this, TaskInformationActivity.class);
				aintent.putExtra("qyid", qyid);
				aintent.putExtra("rwbh", rwbh);
				setResult(RESULT_OK,aintent); 
				DownloadActivityFromTaskinfo.this.finish();
				break;
			default:
				break;
			}
		...
		public void run() {
			...
			for (int count = 0; count < tablesArray.length; count++) {
				...
				try {
					...
					if("T_ZFWS_XWJLWD".equals(tablename.trim())){
	...
	private void showSyncLog() {
		...
		AlertDialog.Builder ab = new AlertDialog.Builder(DownloadActivityFromTaskinfo.this);
		ab.setTitle("同步日志");
		ab.setIcon(DownloadActivityFromTaskinfo.this.getResources().getDrawable(R.drawable.yutu));
		ScrollView avScView = new ScrollView(DownloadActivityFromTaskinfo.this);
		avScView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));

		TextView syncLogTv = new TextView(DownloadActivityFromTaskinfo.this);
