...
/**
 * FileName: YFCLXX.java
 * Description: 原辅材料信息
 * @author 王红娟
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司
 * Create at: 2012-12-4 下午04:02:53
 */
public class YFCLXX extends BaseClass implements Serializable, IDetailed, IList {
	
	/** 实体类的名字 */
	public static final String BusinessClassName = "YFCLXX";
	/** 获取该实体类列表样式的标题 */
	private  final String ListStyleName = "ZDWRY_YFCL";
	/** 获取该实体类数据详情样式的标题 */
	private  final String DetailedStyleName = "ZDWRY_YFCL";
	/** 该实体类所在表的主键 */
	private  final String primaryKey = "Guid";
	/** 用于对该实体类进行排序查询，此处用于sql语句拼接进行排序查询 */
	private  final String order = "yfclmc asc";
	/** 查询该实体类的相关信息所用的表名 */
	private  final String tableName = "V_ZDWRY_YFCL";
	/** 该实体类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "原辅材料信息详情";
	/** 该实体类在显示列表的时候所用的名字标题 */
	private String GridTitleText = "原辅材料信息列表";
	/** 初始化当前该实体类列表滚动的次数 */
	...
	public ArrayList<HashMap<String, Object>> getStyleDetailed(Context context) {
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "YFCLXX");
	...
	/**
	 * Description: 设置条件查询的条件
	 * @param filter 条件集合
	 * void
	 * @author 王红娟
	 * Create at: 2012-12-4 下午04:06:36
	 */
