...
/**
 * FileName: CLYJXX.java 
 * Description: 处理意见业务类
 * @author 王红娟
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司 
 * Create at: 2012-11-30 下午02:38:17
 */
public class CLYJXX extends BaseClass implements IDetailed, IList, IQuery,
		Serializable {

	/** 业务类的名字 */
	public static final String BusinessClassName = "CLYJXX";
	/** 获取该业务类列表样式的标题 */
	private  final String ListStyleName = "HJYJ_CLYJBZ";
	/** 获取该业务类数据详情样式的标题 */
	private  final String DetailedStyleName = "HJYJ_CLYJBZ";
	/** 获取该业务类查询样式的标题 */
	private  final String QueryStyleName = "CLYJBZ";
	/** 底部菜单格式文件名 */
	private  final String BottomMenuStyleFileName = "style_bottomMenu_wry.xml";// 底部菜单格式文件名
	/** 该业务类所在表的主键 */
	private  final String primaryKey = "Guid";
	/** 查询该业务类的相关信息所用的表名 */
	private  final String tableName = "T_ZSK_CLYJ";
	/** 该业务类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "处理意见信息详情";
	/** 该业务类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "处理意见信息列表";
	/** 该业务类在执行查询操作的时候所用的名字标题 */
	private String QueryTitleText = "处理意见信息查询";
	/** 初始化当前该业务类列表滚动的次数 */
	 ...
	 * @author 王红娟 
	 * Create at: 2012-11-30 下午02:43:17
	 */
