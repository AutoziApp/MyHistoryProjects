...
/**
 * FileName: SCCLGY.java
 * Description: 生产处理工艺
 * @author 王红娟
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司
 * Create at: 2012-12-4 下午01:40:13
 */
public class SCCLGY extends BaseClass implements Serializable, IDetailed, IList {
	
	/** 实体类的名字 */
	public static final String BusinessClassName = "SCCLGY";
	/** 获取该实体类列表样式的标题 */
	private  final String ListStyleName = "ZDWRY_SCCLGY";
	/** 获取该实体类数据详情样式的标题 */
	private  final String DetailedStyleName = "ZDWRY_SCCLGY";
	/** 该实体类所在表的主键 */
	private  final String primaryKey = "Guid";
	/** 排序的字段，此处用来拼接sql语句进行排序查询 */
	private  final String order = "scgy desc";
	/** 查询该实体类的相关信息所用的表名 */
	private  final String tableName = "V_ZDWRY_SCCLGY";
	/** 该实体类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "生产处理工艺信息详情";
	/** 该实体类在显示列表的时候所用的名字标题 */
	private String GridTitleText = "生产处理工艺信息列表";
	/** 初始化当前该实体类列表滚动的次数 */
	...
	public ArrayList<HashMap<String, Object>> getStyleDetailed(Context context) {
		...
		try {
			...
			ExceptionManager.WriteCaughtEXP(e, "SCCLGY");
	...
	public ArrayList<HashMap<String, Object>> getDataList(
		...
		LogUtil.d("fliterHashMap", fliterHashMap.size()+""+filterSql);
		String newSql = null;
		if("".equals(filterSql)){
			newSql = sql.replace(",,", "");
		}else{
	...
	/**
	 * Description: 设置查询条件
	 * @param filter 要限制的条件集合
	 * void
	 * @author 王红娟
	 * Create at: 2012-12-4 下午01:45:37
	 */
