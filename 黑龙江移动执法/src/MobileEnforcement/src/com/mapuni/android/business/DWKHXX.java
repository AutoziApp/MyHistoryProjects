...
/**
 * FileName: DWKHXX.java
 * Description: 队伍考核业务类
 * @author 包坤
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司
 * Create at: 2012-11-30 下午04:54:26
 */
public class DWKHXX extends BaseClass implements IDetailed, IList, IQuery,
		Serializable {
	
	/**业务类的名字*/
	public static final String BusinessClassName = "DWKHXX";
	/**获取该业务类列表样式的标题*/
	...
	/** 查询该业务类的相关信息所用的表名*/
	private  final String tableName = "T_ZSK_Expert_New";
	/**该业务类在显示详情是所用的名字标题*/
	private String DetailedTitleText = "队伍考核信息详情";
	/**该业务类在显示列表的时候所用的名字标题*/
	private String ListTitleText = "队伍考核信息列表";
	/**该业务类在执行查询操作的时候所用的名字标题*/
	private String QueryTitleText = "队伍考核信息查询";
	/**初始化当前该业务类列表滚动的次数*/
