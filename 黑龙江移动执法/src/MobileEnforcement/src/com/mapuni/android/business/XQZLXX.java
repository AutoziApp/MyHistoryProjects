 ...
 * Create at: 2012-12-4 下午03:01:26
 */
public class XQZLXX extends BaseClass implements Serializable, IDetailed,
	...
	/** 该实体类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "限期治理信息详情";
	/** 该实体类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "限期治理信息列表";
	/** 该实体类在执行查询操作的时候所用的名字标题 */
	private String QueryTitleText = "限期治理信息查询";
	/** 初始化当前该实体类列表滚动的次数 */
	 ...
	 * String
	 * @author 王红娟
	 * Create at: 2012-12-4 下午03:05:07
	 */
...
//				+ ")";
	 ...
	 * String
	 * @author 王红娟
	 * Create at: 2012-12-4 下午03:03:19
	 */
