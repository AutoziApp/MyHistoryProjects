 ...
 * Create at: 2012-12-4 上午10:20:57
 */
public class PWXKZXX extends BaseClass implements Serializable, IDetailed,
	...
	/** 该实体类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "排污许可证信息详情";
	/** 该实体类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "排污许可证信息列表";
	/** 该实体类在执行查询操作的时候所用的名字标题 */
	private String QueryTitleText = "排污许可证信息查询";
	/** 初始化当前该实体类列表滚动的次数 */
	 ...
	 * String
	 * @author 王红娟
	 * Create at: 2012-12-4 上午10:21:41
	 */
