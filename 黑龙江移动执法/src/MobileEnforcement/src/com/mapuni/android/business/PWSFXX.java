...
/**
 * FileName: PWSFXX.java 
 * Description: 排污收费
 * @author 王红娟
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司
 *  Create at: 2012-12-4 上午10:10:31
 */
public class PWSFXX extends BaseClass implements Serializable, IDetailed,
		IQuery, IList {

	/** 实体类的名字 */
	public static final String BusinessClassName = "PWSFXX";
	/** 获取该实体类列表样式的标题 */
	private  final String ListStyleName = "WRY_PWSF";
	/** 获取该实体类数据详情样式的标题 */
	private  final String DetailedStyleName = "WRY_PWSF";
	/** 获取该实体类查询样式的标题 */
	private  final String QueryStyleName = "PWSF";
	/** 该实体类所在表的主键 */
	private  final String primaryKey = "Guid";
	/** 获取该实体类底部菜单的标题 */
	private  final String BottomMenuName = "XQ";
	/** 查询该实体类的相关信息所用的表名 */
	private  final String tableName = "V_WRY_PWSF";
	/** 该实体类在显示详情是所用的名字标题 */
	private String DetailedTitleText = "排污收费信息详情";
	/** 该实体类在显示列表的时候所用的名字标题 */
	private String ListTitleText = "排污收费信息列表";
	/** 该实体类在执行查询操作的时候所用的名字标题 */
	private String QueryTitleText = "排污收费信息查询";
	/** 初始化当前该实体类列表滚动的次数 */
	 ...
	 * String
	 * @author 王红娟
	 * Create at: 2012-12-4 上午10:12:05
	 */
...
//				+ ")";
	 ...
	 * String
	 * @author 王红娟
	 * Create at: 2012-12-4 上午10:18:46
	 */
