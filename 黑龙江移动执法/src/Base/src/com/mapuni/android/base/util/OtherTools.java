...
public class OtherTools {
	...
	public static Builder getAlertDialog2(Context context, CharSequence title, CharSequence msg, OnClickListener positiveListener, CharSequence tip, OnClickListener neutralListener) {
		AlertDialog.Builder builder = new AlertDialog.Builder(context);
		builder.setTitle(title);
		builder.setMessage(msg);
		//builder.setPositiveButton("确定", positiveListener);
	...
	public static void startTimePicker() {
	}
}
