...
//            String url= PathManager.PathUrl+data.getFilePath()+data.getName();
...
//
//                FileDownUtil.getInstance(context).downLoadWord(url,data.getName());
//
//            } else{//视频格式
//                Intent intent=new Intent(context,PlayerActivity.class);
//                intent.putExtra("videoUrl",url);
//                intent.putExtra("videoName",data.getName());
//                context.startActivity(intent);
//            }
        }
