...
import com.mapuni.shangluo.bean.ContactBean;
import com.mapuni.shangluo.manager.NetManager;
import com.mapuni.shangluo.utils.SPUtils;
import com.mapuni.shangluo.view.recyclerTreeView.bean.Dir;
import com.mapuni.shangluo.view.recyclerTreeView.bean.File;
import com.mapuni.shangluo.view.recyclerTreeView.viewbinder.DirectoryNodeBinder;
import com.mapuni.shangluo.view.recyclerTreeView.viewbinder.FileNodeBinder;
    ...
    public void initData() {
        ...
        adapter.setOnTreeNodeListener(new TreeViewAdapter.OnTreeNodeListener() {
            ...
            public void onResponse(String response, int id) {
                ...
                List<ContactBean> list=gson.fromJson(response.toString(),type);
