...
//        addView(shadowView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        ...
        mTabLayout.setBackgroundColor(context.getResources().getColor(R.color.tab_bottom_unselect));
    ...
    private void toggle(final boolean visible, final boolean animate, boolean force) {
        if (mVisible != visible || force) {
            ...
            if (height == 0 && !force) {
                ...
                if (vto.isAlive()) {
                    // view鏍戝畬鎴愭祴閲忓苟涓斿垎閰嶇┖闂磋�岀粯鍒惰繃绋嬭繕娌℃湁寮�濮嬬殑鏃跺�欐挱鏀惧姩鐢汇��
...
//                setTranslationY(BottomBar.this, translationY);
