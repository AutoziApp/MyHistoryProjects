...
public class CreatedTaskRecyclerItemFactory extends AssemblyRecyclerItemFactory<CreatedTaskRecyclerItemFactory.CreatedTaskRecyclerItem> {

    private Context baseContext;

    public CreatedTaskRecyclerItemFactory(Context context) {
        baseContext=context;
    }
    ...
    public CreatedTaskRecyclerItem createAssemblyItem(ViewGroup viewGroup) {
        return new CreatedTaskRecyclerItem(R.layout.list_item_created_task,viewGroup);
    }
    ...
    public interface EventListener{
        ...
        void onClickDel(int position, CreatedTaskListBean.RowsBean rowsBean);
    }
        ...
        protected void onConfigViews(final Context context) {
            btnDistribute.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ((XflcActivity)baseContext).onClickDistribute(getLayoutPosition(),getData());
                }
            });
            ...
            btnEdit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((XflcActivity)baseContext).onClickEdit(getLayoutPosition(),getData());
                }
            });
            ...
            btnDel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ((XflcActivity)baseContext).onClickDel(getLayoutPosition(),getData());
                }
            });
        }
