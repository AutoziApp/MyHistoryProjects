    ...
    public static List<?> sortByMethod(List<?> list, final String method,
        ...
        Collections.sort(list, new Comparator() {
            public int compare(Object a, Object b) {
                int ret = 0;
                try {
                    Method m = a.getClass().getMethod(method, new Class[0]);
                    ...
                    if (type == int.class) {
                        ...
                        ret = ((Comparable) m.invoke(a, new  Object[]{}))
                                .compareTo((Comparable) m.invoke(b, new  Object[]{}));
                    } else {
                        ret = String.valueOf(m.invoke(a, new  Object[]{})).compareTo(
                                String.valueOf(m.invoke(b, new  Object[]{})));
                    }
                    ...
                    public int compare(Object a, Object b) {
                        ...
                        try {
                            ...
                            if (type == int.class) {
                                ...
                                ret = String.valueOf(m.invoke(a, new  Object[]{}))
                                        .compareTo(
                                                String.valueOf(m
                                                        .invoke(b, new  Object[]{})));
                            }
