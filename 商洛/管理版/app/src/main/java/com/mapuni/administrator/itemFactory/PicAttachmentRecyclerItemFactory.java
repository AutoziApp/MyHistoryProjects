...
//                    clearLoginMsg();
                ...
                public void onResponse(String response, int id) {
                    try {
                        ...
                        if (jsonObject.optString("status").equals("0")) {
                            ...
                            } else if (TypeUtil.isMP3Type(extension)) {//mp3/4格式
    ...
    public class AttachmentRecyclerItem extends AssemblyRecyclerItem<AttachmentBean.RowsBean> {
        ...
        protected void onFindViews() {
            ...
            //控制删除按钮的显示与隐藏
            if (flag!=null){
                if (DistributionActivity.class.getSimpleName().equals(flag)
                        || DownTaskDetailActivity.class.getSimpleName().equals(flag)
