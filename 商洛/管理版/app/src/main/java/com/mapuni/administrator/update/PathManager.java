...
package com.mapuni.administrator.update;
...
public class PathManager {
	...
	public static final String SDCARD_APK_LOCAL_PATH = SDCARD_RASK_DATA_PATH + "AutoUpdate/shangluoAdmin.apk";
	 ...
	 * 检查更新
	 */
	public static final String VERSION_URL=BASE_URL+"/AppUpdate/adminVersion.xml";
