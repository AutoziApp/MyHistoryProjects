...
import com.mapuni.administrator.activity.myNewsAc.DistributionActivity1;
...
public class DistributionProcessRecyclerItemFactory1 extends AssemblyRecyclerItemFactory<DistributionProcessRecyclerItemFactory1.HandleProcessRecyclerItem> {

    private EventListener mEventListener;
    private Context baseContext;

    public DistributionProcessRecyclerItemFactory1(Context context) {
        ...
        private void requestDelete(GridNameBean bean) {
            NetManager.requestDeleteDistribution(bean.getUuid(), new StringCallback() {
                ...
                public void onResponse(String response, int id) {
                    Logger.i(DistributionProcessRecyclerItemFactory1.class.getSimpleName(),response.toString());
                    try {
                        ...
                        ((DistributionActivity1)context).requestListData();
