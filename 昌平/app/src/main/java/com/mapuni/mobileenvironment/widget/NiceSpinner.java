package com.mapuni.mobileenvironment.widget;
...
import com.mapuni.mobileenvironment.adapter.NiceSpinnerAdapter;
...
//        setBackground(getResources().getDrawable(R.drawable.selector));
        textColor = typedArray.getColor(R.styleable.NiceSpinner_textTint,getResources().getColor(R.color.gray));
        ...
        listView.setDivider(getResources().getDrawable(R.mipmap.line));
