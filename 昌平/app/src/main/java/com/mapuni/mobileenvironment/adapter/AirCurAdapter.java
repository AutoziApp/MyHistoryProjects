...
public class AirCurAdapter extends BaseAdapter {
    private List<AirCurData.DataBean> list;
    private Context context;
    private List<Double> valueList;
    private String valueTag;
    private int mId = 0;

    public AirCurAdapter(List<AirCurData.DataBean> list, List<Double> valueList, Context context, String valueTag) {
        this.list = list;
    ...
    public void change(String tag,int id){
        valueTag = tag;
        mId = id;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        AirCurData.DataBean dataBean = list.get(i);
        ...
        int level = PollutionLevelCalUtil.getHourLevel(valueTag, valueList.get(i));
