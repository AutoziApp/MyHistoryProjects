...
public class YouYanActivity extends ActivityBase {
    ...
    public void initView(){
        ...
        listview.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view,
                ...
                Intent intent = new Intent(YouYanActivity.this,YouYanDetailActivity.class);
    ...
    private void initList() {
        ...
        adapter = new MyExpandableListViewAdapter(dataset, parentList, YouYanActivity.this);
    ...
    private void search(){
        ...
        OkHttpUtils.get().url(PathManager.GetEnterList1).build().execute(new StringCallback() {
            @Override
