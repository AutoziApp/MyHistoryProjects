...
public class SupportFragment extends Fragment {
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onCloseToolbar(boolean bool);
    }
    @Override
    ...
    public void onAttach(Activity activity) {
        ...
        this._mActivity =(AppCompatActivity)  activity;
    }
    /**
     * 加载多个根Fragment
     */
    ...
    public void loadFragmentAllHide( FragmentManager manager,int containerId,SupportFragment... tos) {
//        FragmentManager fragmentManager = _mActivity.getSupportFragmentManager();
    ...
    public void start(FragmentManager fragmentManager, int containerId, SupportFragment fragment) {
     ...
     */
    void showHideFragment(FragmentManager fragmentManager, SupportFragment showFragment, SupportFragment hideFragment, int show, int hide) {
...
//            hideFragment = (SupportFragment) _mActivity.getCurrentFragment();
//        }
        ft.hide(hideFragment).show(showFragment).commit();
    }
    public void showFragment(FragmentManager fragmentManager, SupportFragment showFragment, SupportFragment hideFragment) {
        // 如果show和hide的Fragment不是同一个
        FragmentTransaction ft = fragmentManager.beginTransaction();
     ...
     */
    void replaceTransaction(int containerId, FragmentManager fm, SupportFragment to, boolean addToBack, int show, int hide) {
...
//        ft.setCustomAnimations(R.anim.h_fragment_enter, R.anim.h_fragment_exit);
     ...
     * replace事务, 主要用于子Fragment之间的replace
     */
    void replaceTransaction(int containerId, FragmentManager fm, SupportFragment to, boolean addToBack, Bundle bundle) {
        bindContainerId(containerId, to);
        FragmentTransaction ft =fm.beginTransaction();
    ...
    void showHideFragment(FragmentManager fragmentManager, SupportFragment showFragment, SupportFragment hideFragment, int id, Bundle bundle) {
        if (showFragment == hideFragment) return;
        // 如果show和hide的Fragment不是同一个
        FragmentTransaction ft = fragmentManager.beginTransaction();
        if(!showFragment.isAdded()){
            ft.add(id,showFragment,showFragment.getClass().getName());
        }
