...
//------------------yangjunying-----------------------
	...
	public long insertNoTransaction(ArrayList<ContentValues> values, String table) throws SQLiteException {
		...
		try {
			...
			OtherTools.showLog("----------insertNoTransaction----------数据库插入异常--------------------");
		} finally {
			db.endTransaction();
			db.close();
	...
	public void deleteTransactioneExecSQL(String deleteSql) {
		try {
			db = getConnection();
			/* 执行删除操作 */
	...
	public ArrayList<HashMap<String, Object>> getList(String table, HashMap<String, Object> conditions) {
		...
		try {
			...
			Log.e("FFF", "getList=======" + sql.toString());
			ArrayList<HashMap<String, Object>> data = queryBySqlReturnArrayListHashMap(sql.toString());
	...
	public ArrayList<HashMap<String, Object>> getOrderList(String table, HashMap<String, Object> conditions, String order) {
		...
		try {
			...
			Log.e("FFF", "sql.toString()==" + sql.toString());
			ArrayList<HashMap<String, Object>> data = queryBySqlReturnArrayListHashMap(sql.toString());
