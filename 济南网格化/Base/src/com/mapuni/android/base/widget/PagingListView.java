...
/**
 * 分页加载listview 设置setOnPageCountChangListener实现分页监听
 * 重写onAddPage方法后发送成功消息隐藏进度条，加载完全部数据后设置isCompleted为true
 * 
 * @author wanglg
 * 
 */
public class PagingListView extends ListView {
	...
	private class MyScrollListener implements OnScrollListener {
		...
		public void onScrollStateChanged(AbsListView view, int scrollState) {
			if (scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE && !isCompleted) {
