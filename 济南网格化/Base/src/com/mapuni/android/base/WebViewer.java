...
/**
 * FileName: WebViewer.java Description:显示网页的页面
 * 
 * @author 王振洋
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司 Create at: 2012-12-4 上午11:24:04
 */
public class WebViewer extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 * 
		 * @Override public void onClick(View arg0) { Bundle bundle=new
		 * Bundle(); Intent intent=null; LSGXXX lsgxxx; try { lsgxxx = (LSGXXX)
		 * ObjectFactory .createObject(LSGXXX.BusinessClassName);
		 * bundle.putSerializable("BusinessObj", lsgxxx);
		 * bundle.putBoolean("IsShowTitle", true);
		 * bundle.putBoolean("IsShowSyncBtn", false); HashMap<String, Object>
		 * filterMap = new HashMap<String, Object>(); filterMap.put("cym", "");
		 * lsgxxx.setFilter(filterMap); intent = new Intent(WebViewer.this,
		 * DailogListActivity.class); intent.putExtras(bundle);
