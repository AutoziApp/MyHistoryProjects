...
/**
 * FileName: GISLocation.java Description: 获取当前位置工具类，使用单例模式
 * 
 * @author
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司 Create at: 2013-1-15 下午04:19:40
 */
public class GISLocation {
	 ...
	 * @author 王红娟 Create at: 2012-12-5 下午03:36:08
	 */
	public Location getLocation(Context context) {
		...
		if (provider != null) {
			...
			if (mlocation != null) {
				...
				} else if (Manager.isProviderEnabled(Manager.NETWORK_PROVIDER)) {// 在室内无法获取当前位置采用NET定位
					return location = Manager.getLastKnownLocation(Manager.NETWORK_PROVIDER);

				} else {
					return location = Manager.getLastKnownLocation(provider);
				}
			}
	 ...
	 * @param location
	 *            获取到的新的地理位置信息对象 void
	 * @author 王红娟 Create at: 2012-12-5 下午03:36:33
	 */
