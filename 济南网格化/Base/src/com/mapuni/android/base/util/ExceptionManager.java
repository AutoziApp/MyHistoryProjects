...
import com.mapuni.android.dataprovider.RecordLog;

/**
 * FileName: CrashExceptionCatcher.java Description:崩溃异常的捕获类，捕获后执行一些方法
 * 
 * @author 柳思远
 * @Version 1.3.4
...
public class ExceptionManager implements UncaughtExceptionHandler {
	 ...
	 * 
	 * @return 返回类的实例 RecordLog
	 * @author 柳思远 Create at: 2012-12-6 下午04:36:43
	 */
	...
	/**
	 * Description: 初始化,注册Context对象, 获取系统默认的UncaughtException处理器,
	 * 设置该CrashHandler为程序的默认处理器
	 * 
	 * @param ctx
	 *            上下文
	 * @author 柳思远 Create at: 2012-12-6 下午05:05:05
	 */
	...
	/**
	 * 当UncaughtException发生时会转入该函数来处理 <li>休眠三秒，停止进程
	 */
	@Override
	 ...
	 * @param ex
	 *            上下文
	 * @return true:如果处理了该异常信息;否则返回false boolean
	 * @author 柳思远 Create at: 2012-12-6 下午05:06:19
	 */
