...
/**
 * FileName: AboutActivity.java Description:关于系统页面
 * 
 * @author 王振洋
 * @Version 1.3.4
 * @Copyright 中科宇图天下科技有限公司 Create at: 2012-12-3 上午9:06:21
 */
public class AboutActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mWebView = new WebView(this);// (WebView)
										// this.findViewById(R.id.yutuWebViewer);
	 ...
	 * 
	 * @return String 显示内容
	 * @author 王振洋 Create at: 2012-12-3 上午10:10:10
	 */
